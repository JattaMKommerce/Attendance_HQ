...
CREATE TABLE IF NOT EXISTS `ai_insights` (
  ...
  `detailed_explanation` text COLLATE utf8mb4_unicode_ci,
  `description` text COLLATE utf8mb4_unicode_ci,
  `supporting_data` json DEFAULT NULL,
  `dedup_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `detected_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `confidence_score` decimal(5,2) DEFAULT NULL,
  `status` enum('unread','read','dismissed','new','reviewed','actioned') COLLATE utf8mb4_unicode_ci DEFAULT 'unread',
  ...
  KEY `idx_insights_org_dedup` (`organization_id`,`dedup_key`),
  KEY `idx_insights_org_status_sev` (`organization_id`,`status`,`severity`),
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `marital_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'single',
...
-- ============================================================================
-- INITIAL SEED DATA FOR CPANEL (Organization, Users, Employees, Departments)
...
-- 2. Departments
INSERT IGNORE INTO `departments` (`id`, `organization_id`, `name`) VALUES
(1, 1, 'Engineering'),
(2, 1, 'IT'),
(3, 1, 'Sales'),
(4, 1, 'HR'),
...
-- 3. Designations
INSERT IGNORE INTO `designations` (`id`, `organization_id`, `name`) VALUES
...
-- 4. Initial Users (Super Admin, Org Admin, Employee)
INSERT INTO `users` (`id`, `organization_id`, `email`, `password_hash`, `first_name`, `last_name`, `status`) VALUES
(1, NULL, 'superadmin@hrms.com', '$2b$10$xOYsgf/2m8/LP4s.ta7itOq.MkzKjIlM5eeczHvgD1K0ZiL9XP7re', 'Super', 'Admin', 'active'),
(2, 1, 'admin@acme.com', '$2b$10$xOYsgf/2m8/LP4s.ta7itOq.MkzKjIlM5eeczHvgD1K0ZiL9XP7re', 'Admin', 'Acme', 'active'),
(3, 1, 'employee@acme.com', '$2b$10$xOYsgf/2m8/LP4s.ta7itOq.MkzKjIlM5eeczHvgD1K0ZiL9XP7re', 'Bob', 'Employee', 'active')
ON DUPLICATE KEY UPDATE `password_hash` = VALUES(`password_hash`), `status` = 'active';

-- 5. User Roles Mapping
INSERT IGNORE INTO `user_roles` (`user_id`, `role_id`) VALUES
(1, 1), -- Super Admin
(2, 2), -- Org Admin (Acme Corp)
(3, 7); -- Standard Employee

-- 6. Initial Employee Profile for Employee Bob
INSERT INTO `employees` (`id`, `organization_id`, `user_id`, `employee_code`, `first_name`, `last_name`, `email`, `department_id`, `designation_id`, `employment_status`, `date_of_joining`)
VALUES (1, 1, 3, 'EMP-004', 'Bob', 'Employee', 'employee@acme.com', 1, 1, 'active', '2026-01-15')
ON DUPLICATE KEY UPDATE `first_name` = VALUES(`first_name`), `last_name` = VALUES(`last_name`), `employment_status` = 'active';

-- 7. Additional Test Employees
INSERT INTO `employees` (`id`, `organization_id`, `user_id`, `employee_code`, `first_name`, `last_name`, `email`, `department_id`, `designation_id`, `employment_status`, `date_of_joining`) VALUES
(2, 1, NULL, 'EMP-001', 'Rahul', 'Sharma', 'rahul@acme.com', 1, 2, 'active', '2025-06-01'),
(3, 1, NULL, 'EMP-115', 'Priya', 'Patel', 'priya@acme.com', 4, 3, 'active', '2025-08-15'),
(4, 1, NULL, 'EMP-005', 'Charlie', 'Worker', 'charlie@acme.com', 3, 4, 'active', '2026-02-01')
ON DUPLICATE KEY UPDATE `first_name` = VALUES(`first_name`), `last_name` = VALUES(`last_name`);

-- 8. Leave Types
INSERT IGNORE INTO `leave_types` (`id`, `organization_id`, `name`, `code`, `days_allowed`, `paid`, `carry_forward`) VALUES
(1, 1, 'Casual Leave', 'CL', 12, 1, 0),
...
-- ============================================================================
-- BASELINE SCHEMA & INITIAL SEED INITIALIZATION COMPLETE
-- ============================================================================
